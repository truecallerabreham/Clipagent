<p align="center">
    ...
    <h1 align="center">⚡ clipagent API ⚡</h1>
    <h3 align="center">A FastAPI backend for serving clipagent’s video tools</h3>
</p>

Welcome to the clipagent API!


This is the layer that connects it all—exposing the tools and prompts defined by clipagent MCP and making them accessible through a clean, efficient FastAPI interface.


clipagent API is one of three core components of the full clipagent stack (take a peek at the [Docker Compose file](../docker-compose.yml) to see them all), and while it works best with its companions, it can also run solo if needed.
...
clipagent API is built with Python and FastAPI, and uses uv for managing dependencies.
